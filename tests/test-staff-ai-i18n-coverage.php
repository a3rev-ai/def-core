...
/**
 * The eight "Ask X how this works" entries build their keys from a base
 ...
 * bases are expanded here — otherwise collapsing the eight near-identical
...
assert_same( 8, count( $ak[1] ), 'the console wires eight Ask entries through askEntry()' );
