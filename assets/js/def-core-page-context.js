...
(function () {
	...
	function build(threadId) {
		...
		// Joe partner-context (7.7.0): the referring partner, resolved
		// server-side (the /p/ visit or the first-touch attribution cookie).
		// DEF renders one line so Joe can acknowledge the referral.
