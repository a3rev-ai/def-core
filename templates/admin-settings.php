	...
	>
		...
		<div class="def-core-card">
			...
			<div class="def-core-field">
				...
				/>
				<p class="description">
					<?php esc_html_e( 'Link to your privacy policy, terms and conditions, or other legal page. If set, a link with the label below is shown alongside the AI notice and at the bottom of the chat panel (when a Compliance Footer is configured).', 'digital-employees' ); ?>
				</p>
			</div>
			...
			<div class="def-core-field">
				...
				/>
				<p class="description">
					<?php esc_html_e( 'Text shown for the legal link (e.g. "Privacy Policy", "Terms and Conditions", "Legal"). Defaults to "Privacy Policy" if left empty. Max 50 characters.', 'digital-employees' ); ?>
				</p>
			</div>
			...
			<div id="def-core-ai-notice-preview" class="def-core-notice def-core-notice-info" style="<?php echo $chat_settings['ai_notice'] ? '' : 'display: none;'; ?>">
				<p>
					...
					<?php if ( $chat_settings['privacy_url'] ) : ?>
						<a href="#"><?php echo esc_html( $chat_settings['privacy_link_label'] ?: __( 'Privacy Policy', 'digital-employees' ) ); ?></a>
					<?php endif; ?>
				</p>
			</div>
		</div>
