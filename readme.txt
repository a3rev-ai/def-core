...
* Feature: compliance footer. Admin-configurable text (max 500 chars) shown at the bottom of the chat panel. Ships with a sensible default — *"AI content may be inaccurate. In using our AI you agree to our Terms and Conditions"* — that admins can edit or clear. The existing Legal Link URL is appended as a link with the configured Legal Link Label if set.
