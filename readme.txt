...
* Feature: optional compliance footer. Admin-configurable text (max 500 chars) shown at the bottom of the chat panel — for tenants who want an inline disclaimer (e.g. "AI content may be inaccurate. For licensed work, consult a qualified professional."). The existing Privacy Policy URL is appended as a link if set.
