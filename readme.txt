...
= 7.9.4 - 2026-09-11 =
* Update - Staff AI console: on the Documents page, a document's actions now sit behind the ⋯ menu - Move to project, Download and Delete - with View staying on the card. It is the same card and menu Projects uses; on a phone the menu opens in place under the card. Nothing about what those actions do has changed.
