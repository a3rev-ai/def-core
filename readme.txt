...
= 5.8.5 - 2026-08-12 =
* Improvement: Customer Chat no longer enforces its own 10MB upload limit - your platform's upload ceiling is the one limit (currently 50MB), and if a file is too large the platform's own message is shown. The old in-widget limit had fallen out of step and was refusing files the platform accepts.
