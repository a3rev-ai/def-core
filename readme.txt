...
= 7.8.2 - 2026-09-08 =
* Update - Staff AI: Projects is now a page in the console, like Documents and Scheduled, instead of a box over your chat. It has its own address, so the browser's back button, a phone's back gesture and a reload behave as they do on any site, and the sidebar shows when you are on it. The project cards are exactly as they were, with room to grow down the page; Create project and the Ask how Projects work entry sit at the top, and Create project still opens as a small dialog. Opening a project's documents now moves you to My documents and the back button brings you straight back to Projects. Your chat is hidden while Projects is open, never reset: a reply that is streaming keeps streaming, and a half-typed message is still in the box when you return. Memories, Usage and Connections still open as before; they follow in the next release.
